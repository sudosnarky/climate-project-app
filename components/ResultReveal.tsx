...
export default function ResultReveal({
  ...
  }, [phase.id, selectedIndex]);

  return (
    <div className="min-h-screen w-full bg-black px-6 pt-20 pb-8">
      <div className="max-w-2xl w-full mx-auto animate-fadeSlideUp flex min-h-[calc(100vh-7rem)] flex-col">
        ...
        <div className="mb-12 min-h-40">
          {showExplanation ? (
            ...
            <p className="text-sm font-mono text-gray-500 uppercase tracking-wider pt-2">
